...
conversion_type = st.columns(1)[0].selectbox("Select the type of conversion", ["Lenght","Temperature", "Weight"])
...
def lenght_convertor(value, from_unit, to_unit):
    ...
    return round(((value / lenght_units[from_unit]) * lenght_units[to_unit]), 2)
...
st.markdown(f"<div class='footer'> Developed by Ahmed Farooq </a></div>", unsafe_allow_html=True)
